...
#define DEFAULT_BACKSPACE_BINDING     (BTE_ERASE_ASCII_DELETE)
#define DEFAULT_CURSOR_BLINK_MODE     (BTE_CURSOR_BLINK_SYSTEM)
#define DEFAULT_CURSOR_SHAPE          (BTE_CURSOR_SHAPE_BLOCK)
...
#define DEFAULT_DELETE_BINDING        (BTE_ERASE_DELETE_SEQUENCE)
...
#define TERMINAL_PROFILE_PROPERTY_VALUE_ARRAY_BOXED(prop, propElementName, propElementType, propGSettings)\
  TERMINAL_PROFILE_PROPERTY (PROP_##prop,\
	...
	TERMINAL_PROFILE_PROPERTY_ENUM (BACKSPACE_BINDING,  BTE_TYPE_ERASE_BINDING, DEFAULT_BACKSPACE_BINDING, KEY_BACKSPACE_BINDING);
	TERMINAL_PROFILE_PROPERTY_ENUM (CURSOR_BLINK_MODE, BTE_TYPE_CURSOR_BLINK_MODE, DEFAULT_CURSOR_BLINK_MODE, KEY_CURSOR_BLINK_MODE);
	TERMINAL_PROFILE_PROPERTY_ENUM (CURSOR_SHAPE, BTE_TYPE_CURSOR_SHAPE, DEFAULT_CURSOR_SHAPE, KEY_CURSOR_SHAPE);
	TERMINAL_PROFILE_PROPERTY_ENUM (DELETE_BINDING, BTE_TYPE_ERASE_BINDING, DEFAULT_DELETE_BINDING, KEY_DELETE_BINDING);
