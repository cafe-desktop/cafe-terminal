...
static KeyEntry file_entries[] =
{
	{
		N_("New Tab"),
		KEY_NEW_TAB, ACCEL_PATH_NEW_TAB, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_t, NULL, FALSE, TRUE
	},
	{
		N_("New Window"),
		KEY_NEW_WINDOW, ACCEL_PATH_NEW_WINDOW, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_n, NULL, FALSE, TRUE
	},
	{
		N_("New Profile"),
	...
	{
		N_("Close Window"),
		KEY_CLOSE_WINDOW, ACCEL_PATH_CLOSE_WINDOW, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_q, NULL, FALSE, TRUE
	},
};
...
static KeyEntry edit_entries[] =
{
	{
		N_("Copy"),
		KEY_COPY, ACCEL_PATH_COPY, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_c, NULL, FALSE, TRUE
	},
	{
		N_("Paste"),
		KEY_PASTE, ACCEL_PATH_PASTE, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_v, NULL, FALSE, TRUE
	},
	{
		N_("Select All"),
		KEY_SELECT_ALL, ACCEL_PATH_SELECT_ALL, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_a, NULL, FALSE, TRUE
	}
};
...
static KeyEntry view_entries[] =
{
	...
	{
		N_("Full Screen"),
		KEY_FULL_SCREEN, ACCEL_PATH_FULL_SCREEN, 0, CDK_KEY_F11, NULL, FALSE, TRUE
	},
	{
		N_("Zoom In"),
		KEY_ZOOM_IN, ACCEL_PATH_ZOOM_IN, CDK_CONTROL_MASK, CDK_KEY_plus, NULL, FALSE, TRUE
	},
	{
		N_("Zoom Out"),
		KEY_ZOOM_OUT, ACCEL_PATH_ZOOM_OUT, CDK_CONTROL_MASK, CDK_KEY_minus, NULL, FALSE, TRUE
	},
	{
		N_("Normal Size"),
		KEY_ZOOM_NORMAL, ACCEL_PATH_ZOOM_NORMAL, CDK_CONTROL_MASK, CDK_KEY_0, NULL, FALSE, TRUE
	}
};
...
static KeyEntry search_entries[] =
{
	{
		N_("Find"),
		KEY_SEARCH_FIND, ACCEL_PATH_SEARCH_FIND, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_f, NULL, FALSE, TRUE
	},
	{
		N_("Find Next"),
		KEY_SEARCH_FIND_NEXT, ACCEL_PATH_SEARCH_FIND_NEXT, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_h, NULL, FALSE, TRUE
	},
	{
		N_("Find Previous"),
		KEY_SEARCH_FIND_PREVIOUS, ACCEL_PATH_SEARCH_FIND_PREVIOUS, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_g, NULL, FALSE, TRUE
	}
};
...
static KeyEntry terminal_entries[] =
{
	...
	},
	{
		...
		KEY_PREV_PROFILE, ACCEL_PATH_PREV_PROFILE, CDK_MOD1_MASK, CDK_KEY_Page_Up, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Next Profile"),
		KEY_NEXT_PROFILE, ACCEL_PATH_NEXT_PROFILE, CDK_MOD1_MASK, CDK_KEY_Page_Down, NULL, FALSE, TRUE
	},
};
...
{
	{
		...
		KEY_PREV_TAB, ACCEL_PATH_PREV_TAB, CDK_CONTROL_MASK, CDK_KEY_Page_Up, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Next Tab"),
		KEY_NEXT_TAB, ACCEL_PATH_NEXT_TAB, CDK_CONTROL_MASK, CDK_KEY_Page_Down, NULL, FALSE, TRUE
	},
	{
		N_("Move Tab to the Left"),
		KEY_MOVE_TAB_LEFT, ACCEL_PATH_MOVE_TAB_LEFT, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_Page_Up, NULL, FALSE, TRUE
	},
	{
		N_("Move Tab to the Right"),
		KEY_MOVE_TAB_RIGHT, ACCEL_PATH_MOVE_TAB_RIGHT, CDK_SHIFT_MASK | CDK_CONTROL_MASK, CDK_KEY_Page_Down, NULL, FALSE, TRUE
	},
	{
		N_("Detach Tab"),
	...
	},
	{
		...
		ACCEL_PATH_SWITCH_TAB_PREFIX "1", CDK_MOD1_MASK, CDK_KEY_1, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 2"),
		KEY_SWITCH_TAB_PREFIX "2",
		ACCEL_PATH_SWITCH_TAB_PREFIX "2", CDK_MOD1_MASK, CDK_KEY_2, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 3"),
		KEY_SWITCH_TAB_PREFIX "3",
		ACCEL_PATH_SWITCH_TAB_PREFIX "3", CDK_MOD1_MASK, CDK_KEY_3, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 4"),
		KEY_SWITCH_TAB_PREFIX "4",
		ACCEL_PATH_SWITCH_TAB_PREFIX "4", CDK_MOD1_MASK, CDK_KEY_4, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 5"),
		KEY_SWITCH_TAB_PREFIX "5",
		ACCEL_PATH_SWITCH_TAB_PREFIX "5", CDK_MOD1_MASK, CDK_KEY_5, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 6"),
		KEY_SWITCH_TAB_PREFIX "6",
		ACCEL_PATH_SWITCH_TAB_PREFIX "6", CDK_MOD1_MASK, CDK_KEY_6, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 7"),
		KEY_SWITCH_TAB_PREFIX "7",
		ACCEL_PATH_SWITCH_TAB_PREFIX "7", CDK_MOD1_MASK, CDK_KEY_7, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 8"),
		KEY_SWITCH_TAB_PREFIX "8",
		ACCEL_PATH_SWITCH_TAB_PREFIX "8", CDK_MOD1_MASK, CDK_KEY_8, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 9"),
		KEY_SWITCH_TAB_PREFIX "9",
		ACCEL_PATH_SWITCH_TAB_PREFIX "9", CDK_MOD1_MASK, CDK_KEY_9, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 10"),
		KEY_SWITCH_TAB_PREFIX "10",
		ACCEL_PATH_SWITCH_TAB_PREFIX "10", CDK_MOD1_MASK, CDK_KEY_0, NULL, FALSE, TRUE
	},
	{
		N_("Switch to Tab 11"),
...
{
	{ N_("Contents"), KEY_HELP, ACCEL_PATH_HELP, 0, CDK_KEY_F1, NULL, FALSE, TRUE }
};
                    ...
                    gpointer user_data)
{
	 ...
	 */
	if (edit_keys_store)
		ctk_tree_model_foreach (CTK_TREE_MODEL (edit_keys_store), update_model_foreach, key_entry);
                       ...
                       CtkTreeView          *view)
{
	...
	if (n_entries > 0)
	{
		if (entries[0].accel_path_quark != g_quark_from_string (ke->accel_path))
		{
			...
			dialog =
			    ctk_message_dialog_new (CTK_WINDOW (ctk_widget_get_toplevel (CTK_WIDGET (view))),
                              ...
                              gpointer use_data)
{
	...
	{
		terminal_util_show_help ("cafe-terminal-shortcuts", CTK_WINDOW (editor));
		return;
	}
...
terminal_edit_keys_dialog_show (CtkWindow *transient_parent)
{
	...
	ctk_tree_sortable_set_sort_func (CTK_TREE_SORTABLE (tree),
	                                 KEYVAL_COLUMN, accel_compare_func,
	                                 NULL, NULL);
	ctk_tree_sortable_set_sort_column_id (CTK_TREE_SORTABLE (tree), ACTION_COLUMN,
	                                      CTK_SORT_ASCENDING);

	ctk_tree_view_set_model (CTK_TREE_VIEW (tree_view), CTK_TREE_MODEL (tree));
	g_object_unref (tree);
	...
	g_signal_connect (dialog, "response",
	                  ...
	                  NULL);
	ctk_window_set_default_size (CTK_WINDOW (dialog), -1, 350);

done:
	ctk_window_set_transient_for (CTK_WINDOW (edit_keys_dialog), transient_parent);
	ctk_window_present (CTK_WINDOW (edit_keys_dialog));
}
